...
public class DLGraphTest {
    ...
    private DLGraph<String,String> graph1;
    ...
    public void testGetAllNodesOnConstruction() {
        Set<Node<String>> allNodes = new HashSet<>();
    ...
    public void testGetAllEdgesForNodeWithNoEdges() {
        Set<Edge<String,String>> allEdges = new HashSet<>();
        graph1.addNode(a);
    ...
    public void testGetAllChildrenForNodeWithNoChildren() {
        Set<Node<String>> allChildren = new HashSet<>();
        graph1.addNode(a);
